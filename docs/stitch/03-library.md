...
* **Header Hierarchy:**
  * Eyebrow: `DISCOVER STORIES` (11px, 700 uppercase, letter-spacing `0.12em`, `#E65A00`).
...
* **Category Filter Toolbar:**
  ...
  * Active pill: `#E65A00` solid background with pure `#FFFFFF` bold text and subtle shadow.
...
* **Audiobook Card (`.book-card`):**
  ...
  * Progress track (if started): 4px accent line with percentage label.
